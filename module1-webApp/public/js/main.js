    ...
    if (query) {
        try {
            ...
            if (recipes.length === 0) {
                ...
                container.innerHTML = `
                    <p class="message">
                        Sorry, we couldn't find any recipes for "<strong>${query}</strong>".<br>
                        Try searching for foods like <strong>Chicken</strong>, <strong>Rice</strong>, <strong>Beans</strong>, or <strong>Jollof Rice</strong>.
                    </p>
                `;
                return;
            }
